...
func (my *AddModule) Add(i, j int32) int32 {
	my.req <- tuple[int32, int32]{i, j}
	return <-my.res
}

func (my *AddModule) Close(ctx context.Context) error {
...
func NewAddModule(ctx context.Context, r wazero.Runtime, path string) (*AddModule, error) {
